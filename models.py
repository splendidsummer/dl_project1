...
from keras.layers import Dense, Conv2D, MaxPooling2D, Flatten, Dropout, BatchNormalization,\
    UpSampling2D, Add
from tensorflow.keras.layers import RandomRotation, RandomZoom, CenterCrop, \
...
data_augmentation = Sequential(
  [
    ...
    RandomGray(configs.random_ratio),
  ]
)
...
def model_conv32():
    ...
    model.add(Dense(len(configs.data_classes), activation=(tf.nn.softmax)))
